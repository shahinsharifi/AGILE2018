...
public class CrossOver<T> extends AbstractCrossover<List<T>> {


    public CrossOver(NumberGenerator<Integer> crossoverPointsVariable, NumberGenerator<Probability> crossoverProbabilityVariable) {
